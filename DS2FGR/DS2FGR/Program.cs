...
int esd_script_begin = 1201;
int warp_obj_inst_begin = 10021122;
int warp_obj_inst_id = 10021101;
int event_param_begin = esd_script_begin;
int warp_point_begin = 500001;

int obj_inst_insert_loc = 57;
int event_loc_insert_loc = 4;
...
try
{
    ...
    Console.WriteLine("[SUCCESS] Files written successfully!");
}
catch (IOException ex)
{
    Console.WriteLine($"[ERROR] {ex.Message}");
